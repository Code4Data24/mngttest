...
export default function Projects() {
    ...
    const filteredProjects = useMemo(() => {
        ...
        return filtered;
    }, [safeProjects, searchTerm, filters.status, filters.priority]);
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative w-full max-w-sm">
                    ...
                    <input
                        ...
                        className="w-full pl-10 text-sm pr-4 py-2 rounded-lg border border-gray-300 dark:border-zinc-700"
                    />
                </div>
                ...
                <select
                    ...
                    className="px-3 py-2 rounded-lg border border-gray-300 dark:border-zinc-700 text-sm"
                >
